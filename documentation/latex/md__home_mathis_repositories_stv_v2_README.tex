...
The specification language was inspired by ISPL (Interpreted Systems Programming Language) from \href{https://vas.doc.ic.ac.uk/software/mcmas/}{\texttt{ MCMAS}}. The detailed syntax for the input format can be derived from $\ast$./src/reader/\{parser.\+y,\mbox{\hyperlink{scanner_8l}{scanner.\+l}}\}$\ast$, which intrinsically make up an EBNF grammar. ~\newline
...
For the smaller graphs use {\itshape dot2png.\+sh} script, which converts all $\ast$.dot$\ast$ files from a current folder to $\ast$.png$\ast$. ~\newline
 For bigger ones use {\ttfamily svg} format (may be viewed in Inkscape) and {\itshape dot2svg.\+sh}.\hypertarget{md__home_mathis_repositories_stv_v2_README_autotoc_md7}{}\doxysection{Web interface}\label{md__home_mathis_repositories_stv_v2_README_autotoc_md7}
The web interface is available at \href{http://stv.cs-htiew.com/}{\texttt{ http\+://stv.\+cs-\/htiew.\+com/}}.\hypertarget{md__home_mathis_repositories_stv_v2_README_autotoc_md8}{}\doxysection{Credits}\label{md__home_mathis_repositories_stv_v2_README_autotoc_md8}
